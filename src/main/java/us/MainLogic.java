...
//        waitForInvisibilityOfElementLocated(elements.alertSuccessLocator);
    ...
    /**
     * Checks if web-element's class attribute contains a specific css class name
     *
     * @param element   the web-element
     * @param className the name of css class
     * @return true will be returned if class attribute contains class name,
     * and false if class attribute doesn't contain class name
     */
    public boolean hasClass(WebElement element, String className) {
        String classes = element.getAttribute(Variables.CSS_CLASS_ATR);
